...
export const MobileBottomNav = ({ cartCount = 0 }) => {
  ...
  return (
    <nav className="fixed bottom-[calc(0.75rem+env(safe-area-inset-bottom,0px))] left-1/2 -translate-x-1/2 w-[calc(100%-24px)] max-w-[420px] z-50 lg:hidden pointer-events-auto">
